...
func (s *Server) RunGateway() error {
	...
	// err := pb.RegisterAttendanceServiceHandlerFromEndpoint(ctx, grpcMux, s.cfg.Server.Port, opts)
	// if err != nil {
	// 	return err
	// }
	// err = pb.RegisterCertificateServiceHandlerFromEndpoint(ctx, grpcMux, s.cfg.Server.Port, opts)
	// if err != nil {
	// 	return err
	// }
	// err = pb.RegisterCheckServiceHandlerFromEndpoint(ctx, grpcMux, s.cfg.Server.Port, opts)
	// if err != nil {
	// 	return err
	// }
	// err = pb.RegisterOfficeServiceHandlerFromEndpoint(ctx, grpcMux, s.cfg.Server.Port, opts)
	// if err != nil {
	// 	return err
	// }
	// err = pb.RegisterScheduleServiceHandlerFromEndpoint(ctx, grpcMux, s.cfg.Server.Port, opts)
	// if err != nil {
	// 	return err
	// }
	// err = pb.RegisterWorkspaceServiceHandlerFromEndpoint(ctx, grpcMux, s.cfg.Server.Port, opts)
	// if err != nil {
	// 	return err
	// }
